...
LARGE_ENOUGH_NUMBER = 256
PngImagePlugin.MAX_TEXT_CHUNK = LARGE_ENOUGH_NUMBER * (1024 ** 2)


class ILSVRC2012D64DataModule(LightningDataModule):
    """
    ...
    Specs:
        - 1000 classes
        - Each image is (3 x varies x varies) (here we default to 3 x 64 x 64)
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.data_dir = f"{data_dir}/ilsvrc2012d64"
    ...
    def val_transform(self) -> Callable:
        ...
        preprocessing = transform_lib.Compose(
            [
                transform_lib.Resize(self.image_size + 16),
                transform_lib.CenterCrop(self.image_size),
                transform_lib.ToTensor(),
                imagenet_normalization(),
            ]
